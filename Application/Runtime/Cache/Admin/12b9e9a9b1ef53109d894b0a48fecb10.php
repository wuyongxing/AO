    ...
    <script>
        $(document).ready(function(){
            $("#submit").click(function(){
                ...
                $.post("/AO/index.php/Admin/Attendence/doAttendence",arr,function(data){
                    if(data == 0)
                        alert("工号不存在");
                    else if(data == 1)
                        alert("请在规定时间内打卡");
    ...
    <div class="container">
        ...
        <div class="row">
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation"><a href="/AO/index.php/Admin/Attendence/index">员工打卡</a></li>
              <li role="presentation" class="active"><a href="/AO/index.php/Admin/Attendence/findAttendence">查询考勤</a></li>
        ...
        <div class="row" style="background-color: #fff; margin-top: 1%; height: 700px;">
            <div class="col-md-10 col-md-offset-2" style="padding: 2% 2% 0% 2%;">
                <form class="form-inline" action="/AO/index.php/Admin/Attendence/findAttendence" method="post">
