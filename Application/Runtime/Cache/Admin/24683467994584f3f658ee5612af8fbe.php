    ...
    <script>
      $(document).ready(function(){
          $("#submit").click(function(){
              ...
              $.post("/AO/index.php/Admin/Project/addSubProject",arr,function(data){
                if(data == 1)
                {
                  alert("新增、修改成功");
                  window.location.href="/AO/index.php/Admin/Project/subProject?pid="+$('#pid').val();
                }
                else
                  alert("新增、修改失败");
              });
          ...
          $(".addPerson").click(function(){
            ...
            var pid = $("#pid").val();
            $.post("/AO/index.php/Admin/Project/addPerson",{'uid':uid,'pid':pid},function(data){
              if(data == 0)
                alert("添加失败");
              else
              {
                alert("添加成功");
                window.location.href="/AO/index.php/Admin/Project/subProject?pid="+pid;
              }
            });
          });
          ...
          $(".deletePerson").click(function(){
            ...
            var pid = $("#pid").val();
            $.post("/AO/index.php/Admin/Project/deletePerson",{'uid':uid,'pid':pid},function(data){
              if(data == 0)
                alert("删除失败");
              else
              {
    ...
    <div class="container">
        ...
        <div class="row">
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation"><a href="/AO/index.php/Admin/Project/index">所有项目</a></li>
              <li role="presentation"><a href="/AO/index.php/Admin/Project/todayOnline">今日待上线</a></li>
              <li role="presentation" class="active"><a href="/AO/index.php/Admin/Project/todayOnlined">今日已上线</a></li>
        ...
        <div class="row" style="background-color: #fff; margin-top: 1%; height: 700px;">
            ...
            <div class="col-md-10 col-md-offset-1" style="border: 2px solid #ddd; border-radius: 10px; padding-left: 3%;">
              <table class="table table-hover">
                ...
                <?php if(is_array($task)): foreach($task as $key=>$val): ?><tr>
                  <td id="<?php echo ($val["spid"]); ?>spid"><?php echo ($val["spid"]); ?></td>
                  <td><a href="/AO/index.php/Admin/Project/task?spid=<?php echo ($val["spid"]); ?>" id="<?php echo ($val["spid"]); ?>title" target="_blank"><?php echo ($val["title"]); ?></a></td>
