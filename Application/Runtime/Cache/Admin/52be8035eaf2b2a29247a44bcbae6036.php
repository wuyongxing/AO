    ...
    <script>
      $(document).ready(function(){
        $("#modifyinfo").click(function(){
          ...
          $.post("/AO/index.php/Admin/Index/doRegister", data, function(data){
            if(data == 1)
            {
              alert("添加成功");
              ...
              <form id="infoForm" onsubmit="return false;">
                ...
                <div class="form-group">
                  ...
                  <select class="btn" style="border: 1px gray solid;" name="gid">
                    <?php if(is_array($departmentinfo)): foreach($departmentinfo as $key=>$vo): ?><option value="<?php echo ($vo["gid"]); ?>"><?php echo ($vo["groupname"]); ?></option><?php endforeach; endif; ?>
                  </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <button class="btn btn-primary" id="modifyinfo">添加</button>
                </div>
              </form>
            </div>
        </div>
