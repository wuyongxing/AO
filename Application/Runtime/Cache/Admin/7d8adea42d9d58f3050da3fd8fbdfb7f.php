        ...
        <div class="row" style="background-color: #fff; margin-top: 1%; height: 700px;">
            ...
            <div class="col-md-8 col-md-offset-2" style="border: 2px solid #ddd; border-radius: 10px; padding-left: 3%;">
              <div class="col-md-offset-4 col-md-4">
                <h3><?php echo ($department["groupname"]); ?></h3>
                <h4>部门名称：<?php echo ($department["groupname"]); ?></h4>
                <h4>成立时间：<?php echo ($department["date"]); ?></h4>
                <h4>部门简介：<?php echo ($department["describe"]); ?></h4>
                <h4>部门负责人：<?php echo ($department["username"]); ?></h4>
                <h4>部门使命：<?php echo ($department["detail"]); ?></h4>
              </div>
            </div>
        </div>
        <div class="row">
