    ...
    <div class="container">
        ...
        <div class="row">
            <ul class="nav nav-tabs" role="tablist">
              ...
              <li role="presentation" class="active"><a href="/AO/index.php/Home/Person/findAttendence">考勤</a></li>
        ...
        <div class="row" style="background-color: #fff; margin-top: 1%; height: 700px;">
            <div class="col-md-8 col-md-offset-3" style="padding: 2% 2% 0% 2%;">
                <form class="form-inline" action="/AO/index.php/Home/Person/findAttendence" method="post">
