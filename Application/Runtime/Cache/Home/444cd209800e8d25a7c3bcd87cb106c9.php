    ...
    <script>
      $(document).ready(function(){
        $("#submit").click(function(){
          ...
          {
            var arr = $("#modifyForm").serialize();
            $.post("/AO/index.php/Home/Person/modifyPassword",arr,function(data){
                if(data == 0)
                    alert("修改失败");
                else if(data == 1)
                    alert("密码错误");
                ...
                {
                    alert("修改成功");
                    window.location.href="/AO/index.php/Home/Person/index";
                }
            });
          }
        });
    ...
    <div class="container">
        ...
        <div class="row">
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="/AO/index.php/Home/Person/index">修改密码</a></li>
        ...
        <div class="row" style="background-color: #fff; margin-top: 1%; height: 700px;">
            <div class="col-md-4 col-md-offset-4" style="border: 1px solid #ddd; border-radius:10px; padding: 2% 2% 0% 2%; text-align: center; margin-top: 10%;">
                <form class="form-horizontal" role="form" id="modifyForm">
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">工号</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="uid" name="uid" value="<?php echo ($uid); ?>" readonly="readonly">
                    </div>
                  </div>
                  <div class="form-group">
