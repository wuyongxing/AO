    ...
    <script>
      $(document).ready(function(){
        $(".cancle").click(function(){
          ...
          $.post("/AO/index.php/Home/Meeting/deleBooking",{'tid':tid},function(data){
            if(data == 1)
            {
              alert("取消成功");
    ...
    <div class="container">
        ...
        <div class="row">
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation"><a href="/AO/index.php/Home/Meeting/index">搜索会议室</a></li>
              <li role="presentation" class="active"><a href="/AO/index.php/Home/Meeting/mybooking">我的预定</a></li>
            ...
            <div class="col-md-8 col-md-offset-2" style="border: 2px solid #ddd; border-radius: 10px; margin-top: 1%;">
              <table class="table table-hover">
                ...
                <?php if(is_array($time)): foreach($time as $key=>$vo): ?><tr>
                    ...
                    <td><button class="cancle btn btn-success" tid="<?php echo ($vo["tid"]); ?>">取消</button></td>
