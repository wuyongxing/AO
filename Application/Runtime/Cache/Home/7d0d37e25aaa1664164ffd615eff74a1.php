    ...
    <div class="container">
        ...
        <div class="row">
            <ul class="nav nav-tabs" role="tablist">
              ...
              <li role="presentation" class="active"><a href="/AO/index.php/Home/Test/mydata">我的数据</a></li>
        ...
        <div class="row" style="background-color: #fff; margin-top: 1%; height: 700px;">
            ...
            <div class="col-md-8 col-md-offset-2" style="border: 2px solid #ddd; border-radius: 10px; margin-top: 1%; padding-left: 3%;">
              <div class="col-md-6" id="pingfen" style="padding: 7% 0% 0% 0%;">
                <div class="col-md-6">
                  <img src="<?php echo ($pic); ?>" style="width: 150px; height: 150px;">
                </div>
                <div class="col-md-6">
                  <h4>昵称:<?php echo ($username); ?></h4>
                  <h4>提交数:<?php echo ($num); ?></h4>
                  <h4>AC题目数:<?php echo ($ac); ?></h4>
                  <h4>AC率:<?php echo ($aclv); ?></h4>
                  <h4>排名:<?php echo ($rank); ?></h4>  
                </div>
              </div>
